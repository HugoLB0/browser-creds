# Script to get chrome browser passwords in windows
...
def get_encryption_key():
    local_state_path = os.path.join(os.environ["USERPROFILE"], "AppData", "Local", "Google", "Chrome", "User Data", "Local State") # find the Local State file
...
if __name__ == "__main__":
    ...
    file = open("chrome_pwd.txt","w") # will save the creds into a txt file
